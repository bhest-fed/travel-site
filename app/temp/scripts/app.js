			...
			value: function createPageSectionWaypoints() {
				...
				this.pageSections.each(function () {
					...
					new Waypoint({
						...
						handler: function handler(direction) {
							if (direction == 'down') {
								var matchingHeadingLink = currentPageSection.getAttribute('data-matching-link');
								that.headerLinks.removeClass('is-current-link');
								(0, _jquery2.default)(matchingHeadingLink).addClass('is-current-link');
							}
						},
						offset: '18%'
					});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = function () {
		...
		_createClass(Modal, [{
			key: 'events',
			value: function events() {
				// clicking the the open modal button
